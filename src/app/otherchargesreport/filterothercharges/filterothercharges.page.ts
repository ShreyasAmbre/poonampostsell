...
@Component({
  selector: 'app-filterothercharges',
  templateUrl: './filterothercharges.page.html',
  styleUrls: ['./filterothercharges.page.scss'],
})
export class FilterotherchargesPage implements OnInit {
  project_master = []
  wing_apidata = []
  floor_apidata = []
  unit_apidata = []
