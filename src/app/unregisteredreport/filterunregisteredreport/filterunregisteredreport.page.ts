...
@Component({
  selector: 'app-filterunregisteredreport',
  templateUrl: './filterunregisteredreport.page.html',
  styleUrls: ['./filterunregisteredreport.page.scss'],
})
export class FilterunregisteredreportPage implements OnInit {
  project_master = []
  wing_apidata = []
  floor_apidata = []
  unit_apidata = []
  ...
  getApartment(id){
    ...
    forkJoin([wingData, floorData, unitData, brokerData]).subscribe(results => {
      ...
      this.broker_apidata = results[3]["data"]
