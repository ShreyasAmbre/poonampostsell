...
@Component({
  selector: 'app-filtersoldunsold',
  templateUrl: './filtersoldunsold.page.html',
  styleUrls: ['./filtersoldunsold.page.scss'],
})
export class FiltersoldunsoldPage implements OnInit {
  project_master = []
  wing_apidata = []
  floor_apidata = []
  unit_apidata = []
