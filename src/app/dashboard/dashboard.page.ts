...
export class DashboardPage implements OnInit {
  ...
  constructor(private noti:NotificationService, private http:HttpClient, public modalCtrl: ModalController, public alertController: AlertController, public platform: Platform) { }
